...
class SLL:
    ...
    def is_empty(self):
        ...
        if self.head == None:
            ...
            return False
            """you can also write it more pythony like below"""
            # return self.head is None  # self.head == None

    def add_front(self, new_data):
        """Add a Node whose data is the new_data argument to the front of the front of the Linked List."""
    ...
    def search(self, data):
        """Traverses the zlinked List and teturns True if the data searched for is present in one of the nodes.  Otherwise, it returns False.
        
        The time complexity is O(n) because in the worst.
        """
        if self.head is None:
            return "Linked List is emtpy. No Nodes to search."
